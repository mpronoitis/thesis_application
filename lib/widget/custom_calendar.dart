...
class CustomCalendarView extends StatefulWidget {
  ...
  final Function(bool)? tryingMethod;
...
class _CustomCalendarViewState extends State<CustomCalendarView> {
  ...
  DateTime currentMonthDate = DateTime(2022, 5, 31, 0, 0, 0, 0, 0);
  DateTime? startDate;
  DateTime? endDate;
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius:
                          const BorderRadius.all(Radius.circular(24.0)),
                      border: Border.all(color: SleepAppTheme.lightText),
                    ),
                    child: Material(
                      color: Colors.transparent,
                      child: InkWell(
                            ...
                            decoration: BoxDecoration(
                              color: startDate != null && endDate != null
                                  ? getIsItStartAndEndDate(date) ||
                                          getIsInRange(date)
                                      ? HexColor('#54D3C2').withOpacity(0.4)
                                      : Colors.transparent
                                  : Colors.transparent,
